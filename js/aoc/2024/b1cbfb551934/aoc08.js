...
var $tortus$elm_array_2d$Array2D$fromArray = function (array) {
	...
	return {h: initialColumns, a: normalizedData};
};
...
var $author$project$Main$initModel = F2(
	function (withHarmonics, dataSource) {
		var board = $author$project$Main$initBoard(dataSource);
		return {H: $elm$core$Set$empty, I: board, R: 0, t: dataSource, T: '', _: '?', s: withHarmonics};
	});
...
var $author$project$Main$updateClear = function (model) {
	return A2($author$project$Main$initModel, model.s, model.t);
};
...
var $author$project$Main$checkAntenna = F2(
	function (board, _v0) {
		var x = _v0.a;
		var y = _v0.b;
...
var $author$project$Main$findAllAntennae = function (board) {
	return A2(
		...
		function (pos) {
			return A2(
				$elm$core$Maybe$map,
				function (ch) {
					return _Utils_Tuple2(ch, pos);
				},
				A2($author$project$Main$checkAntenna, board, pos));
		},
		$author$project$Main$getAllPositions(board));
};
var $author$project$Main$pairs = function (lst) {
	if (!lst.b) {
		...
		var these = A2(
			$elm$core$List$map,
			function (it) {
				return _Utils_Tuple2(h, it);
			},
			t);
		var rest = $author$project$Main$pairs(t);
		return A2($elm$core$List$append, these, rest);
	}
};
var $author$project$Main$findAntinodesForAntenna = F3(
	function (board, antinodeFinder, positions) {
		return A2(
			$elm$core$List$concatMap,
			antinodeFinder(board),
			$author$project$Main$pairs(positions));
	});
...
var $author$project$Main$gatherPositionsForAntenna = F2(
	function (antennae, antenna) {
		return A2(
			$elm$core$List$filterMap,
			function (_v0) {
				var a = _v0.a;
				var lst = _v0.b;
				return _Utils_eq(a, antenna) ? $elm$core$Maybe$Just(lst) : $elm$core$Maybe$Nothing;
			},
			antennae);
	});
var $author$project$Main$groupAntennae = function (antennae) {
	var distinct = $elm$core$Set$toList(
		$elm$core$Set$fromList(
			A2($elm$core$List$map, $elm$core$Tuple$first, antennae)));
	return A2(
		$elm$core$List$map,
		function (ch) {
			return _Utils_Tuple2(
				ch,
				A2($author$project$Main$gatherPositionsForAntenna, antennae, ch));
		},
		distinct);
};
var $author$project$Main$findAllAntinodes = F2(
	function (antinodeFinder, board) {
		var antennae = $author$project$Main$findAllAntennae(board);
		var grouped = $author$project$Main$groupAntennae(antennae);
		var all = A2(
			$elm$core$List$concatMap,
			function (_v0) {
				var a = _v0.a;
				var posList = _v0.b;
				return A3($author$project$Main$findAntinodesForAntenna, board, antinodeFinder, posList);
			},
			grouped);
		return $elm$core$Set$fromList(all);
	});
...
var $author$project$Main$inBounds = F2(
	function (board, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var _v1 = A3($tortus$elm_array_2d$Array2D$get, y, x, board);
...
var $author$project$Main$findAntinodes = F2(
	function (board, _v0) {
		var _v1 = _v0.a;
		var x1 = _v1.a;
		var y1 = _v1.b;
		...
		var candidates = _List_fromArray(
			[
				_Utils_Tuple2(x1 - xd, y1 - yd),
				_Utils_Tuple2(x2 + xd, y2 + yd)
			]);
		return A2(
			$elm$core$List$filter,
			$author$project$Main$inBounds(board),
			candidates);
	});
var $author$project$Main$unfold = F2(
	function (generator, state) {
		var _v0 = generator(state);
		if (!_v0.$) {
			var _v1 = _v0.a;
			var a = _v1.a;
			var s = _v1.b;
			return A2(
				$elm$core$List$cons,
				a,
				A2($author$project$Main$unfold, generator, s));
		} else {
			return _List_Nil;
		}
	});
var $author$project$Main$findAntinodesWithHarmonics = F2(
	function (board, _v0) {
		var _v1 = _v0.a;
		var x1 = _v1.a;
		var y1 = _v1.b;
		...
		var unfolder = F2(
			function (fn, pos) {
				return A2($author$project$Main$inBounds, board, pos) ? $elm$core$Maybe$Just(
					_Utils_Tuple2(
						pos,
						fn(pos))) : $elm$core$Maybe$Nothing;
			});
		var sub = function (_v4) {
			var x = _v4.a;
			var y = _v4.b;
			return _Utils_Tuple2(x - xd, y - yd);
		};
		var subList = A2(
			$author$project$Main$unfold,
			unfolder(sub),
			_Utils_Tuple2(x1, y1));
		var add = function (_v3) {
			var x = _v3.a;
			var y = _v3.b;
			return _Utils_Tuple2(x + xd, y + yd);
		};
		var addList = A2(
			...
			unfolder(add),
			_Utils_Tuple2(x1, y1));
		return A2($elm$core$List$append, subList, addList);
	});
var $author$project$Main$updateSolve = function (model) {
	var board = model.I;
	var antinodeFinder = model.s ? $author$project$Main$findAntinodesWithHarmonics : $author$project$Main$findAntinodes;
	var antinodes = A2($author$project$Main$findAllAntinodes, antinodeFinder, board);
	return _Utils_update(
		model,
		{H: antinodes});
};
var $elm$core$Basics$not = _Basics_not;
var $author$project$Main$updateToggleHarmonics = function (model) {
	var withHarmonics = !model.s;
	return A2($author$project$Main$initModel, withHarmonics, model.t);
};
var $author$project$Main$updateUseInput = function (model) {
	return A2($author$project$Main$initModel, model.s, 0);
};
var $author$project$Main$Sample = 1;
var $author$project$Main$updateUseSample = function (model) {
	return A2($author$project$Main$initModel, model.s, 1);
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			...
			default:
				return _Utils_Tuple2(
					$author$project$Main$updateToggleHarmonics(model),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$Clear = 0;
var $author$project$Main$Solve = 1;
var $author$project$Main$ToggleHarmonics = 4;
var $author$project$Main$UseInput = 3;
var $author$project$Main$UseSample = 2;
...
var $author$project$Main$view = function (model) {
	...
	var nestedPositions = A2(
		...
		ys);
	var antinodes = model.H;
	var countStr = $elm$core$String$fromInt(
		$elm$core$Set$size(antinodes));
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 8: Resonant Collinearity')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2024/day/8')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2024/day/8')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(' With harmonics')
									]))
							]))
					])),
				A2(
